...
/*
	setX, getX can only be called inside the class.
	It cannot be called from the main method.
	The reason being, setX is protected and protected fields
	cannot be accessed outside the base class or derived classes

	x cannot be directly accessed in the derived class as it is
	private in the base class

	Visibility inside the derived class depends on the access
	specifier in the base class
	Visibility/Access outside the derived class depends on the
	type of inheritence i.e. public/protected/private.
*/
class B: public A {
public:
	void setData(int x) {
