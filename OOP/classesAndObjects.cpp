...
/*
	Unless specified otherwise all members of a class are
	private by default
*/
class Point {
private:
...
int main() {
	/*
		Class(user defined type) is description of object (Basically blueprint)
		It is used to describe properties and behaviour of an object
		and provide APIs to manipulate the properties.
		...
		Difference between defining a function inside the class and outside the class:
			--> Functions defined inside the class are inline by default but when they are
				defined outside the class, inline keyword has to be used explicitly to request for
